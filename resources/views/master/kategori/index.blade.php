...
@section('page_title') kategori @endsection
@section('page_subtitle') kategori @endsection
@section('menu')
    <div class="box box-solid" style="text-align:right;">
        <div class="box-body">
            <a href="{{ route('kategori.create') }}" class="modal-show btn btn-success" title="Buat Kategori Baru">
...
@push('scripts')
    <script>
        ...
        var DataTablesGreet = $('#datatable').DataTable({
            ...
            columns: [
                ...
                {data : 'kategory_id', name: 'kategory_id'},
            ]
        });
    </script>
    <script >
    ...
    function reloadWidget() {
       ...
       function myFunction() {
        ...
        if(x == "all") {
            DataTablesGreet.columns(3).search('').draw();
        } else if(x == "aktif") {
            DataTablesGreet.columns(3).search('Aktif').draw();
        } else {
            DataTablesGreet.columns(3).search('Tidak Active').draw();
        }
       }
